                 ...
                 <div class="col-sm-12">
                   <div style="width: 100%;text-align: center"class="titlepage">
                        <form class="modal-content animate" action=" " method="post">
                            ...
                            <select name="status" class="contactus"style="border-radius:5px;" required>
                                   <option select='All' >ALL</option>
                                 <option select='Present' >Present</option>
                                  <option select='Absent' >Absent</option>
                             </select>
                    ...
                    if($result->num_rows>0){
                     ...
                     if($result2->num_rows>0){
                        while ($row2=$result2->fetch_assoc()){
                            ...
                            echo '<td>';
                            $sql3="SELECT * FROM `attendance` WHERE `subid`='$subcode' and `datetime`='$datetime' and sid='$sid'  and `status`='$status';";
